...
\item $\Omega$, the set of possible worlds, is the sample space
  ...
  \item a mapping of $\anymu$ from $\Domain$ to Boolean.  For instance
    ...
    $(\anymu\ 0) = \True,\ (\anymu\ 1) = \False, \ (\anymu\ 2) = \True, \dots$,
...
executed, outputs $\True$ with a probability of \mintinline{scheme}{p} or
$\False$ with a probability of 1 - \mintinline{scheme}{p}.  Let
